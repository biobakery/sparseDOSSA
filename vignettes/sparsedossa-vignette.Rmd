...
```{r run-sparsedossa-help, eval=TRUE, results="hide"} 
?sparseDOSSA 
```
...
```{r default-run, eval=TRUE, cache=TRUE, results="hide"}
...
```{r input-community, eval=TRUE, cache=TRUE, results="hide"}
n.microbes <- 150
n.samples <- 50
n.metadata <- 1
...
```{r bugmeta, eval=TRUE, cache=TRUE, results="hide"}
...
```{r bugbug, eval=TRUE, cache=TRUE, results="hide"}
...
```{r output, eval=TRUE, cache=TRUE, results="hide"}
